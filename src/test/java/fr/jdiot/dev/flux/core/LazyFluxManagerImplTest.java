...
public class LazyFluxManagerImplTest {

  private LazyFluxManagerImpl fluxManager;

  @BeforeEach
  public void setUp() {
    this.fluxManager = new LazyFluxManagerImpl(new FluxProperties());
  }
  ...
  public void testRegisterFluxTimeout() {
    ...
    final LazyFluxManagerImpl manager = new LazyFluxManagerImpl(properties);
